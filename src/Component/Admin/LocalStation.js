    ...
    return (
        <>
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 overflow-x">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="px-6 py-4">$999</td>
                            <td className="px-6 py-4">$999</td>
                            <td className="px-6 py-4 flex gap-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="green" className="w-6 h-6" onClick={handleOpen1}>
            ...
            <Dialog open={open} handler={handleOpen}>
                ...
                <DialogBody className="h-[43rem] overflow-scroll" style={{ height: '450px' }}>
